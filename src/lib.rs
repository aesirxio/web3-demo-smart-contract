...
const TOKEN_METADATA_BASE_URL: &str = "https://web3.aesirx.io/demo/token/";
...
#[init(contract = "aesirx_web3_demo", event = "Cis2Event<ContractTokenId, ContractTokenAmount>")]
...
/// testing.
#[receive(contract = "aesirx_web3_demo", name = "view", return_value = "ViewState")]
