//! AesirX NFT smart contract using the Concordium Token Standard CIS2.
//!
//! # Description
//! This smart contract registers AesirX web3 objects as representations of
//! extended objects in the 1st party servers, such as organisations, users,
//! products, customers, assets, etc.
//!
//! This smart contract also pretends to be a demo, so it's a preview of
//! how AesirX will work.  Some functions, sechemas and definitions will
//! change over time
...
const TOKEN_METADATA_BASE_URL: &str = "https://web3.aesirx.io/demo/v0002/token/";
...
type ContractError = Cis2Error<AesirXContractError>;

type ContractResult<A> = Result<A, ContractError>;

/// Mapping the logging errors to AesirXContractError.
impl From<LogError> for AesirXContractError {
...
/// Mapping errors related to contract invocations to AesirXContractError.
impl<T> From<CallContractError<T>> for AesirXContractError {
    fn from(_cce: CallContractError<T>) -> Self {
        Self::InvokeContractError
    }
}

/// Mapping AesirXContractError to ContractError
impl From<AesirXContractError> for ContractError {
    fn from(c: AesirXContractError) -> Self {
        Cis2Error::Custom(c)
    }
}
...
impl<S: HasStateApi> State<S> {
    ...
    fn mint(
        ...
        state_builder: &mut StateBuilder<S>,
            ...
            AesirXContractError::TokenIdAlreadyExists.into()
        );
...
fn build_token_metadata_url(token_id: &ContractTokenId) -> String {
    ...
    token_metadata_url.push_str(".json");
    token_metadata_url
}
...
#[init(
    contract = "aesirx_web3_demo_v0002",
